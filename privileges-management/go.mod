...
require (
	...
	github.com/dlampsi/adc v0.6.0 // indirect
	github.com/dlampsi/generigo v1.6.0 // indirect
	...
	github.com/korylprince/go-ad-auth v2.2.0+incompatible // indirect
